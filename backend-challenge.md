...
## Coding exercise
As a backend engineer, you'll be working with APIs (Such as Google's Location API set). This challenge is designed to give you the opportunity to show your ability to query an API using languages that are commonly used during operations.
